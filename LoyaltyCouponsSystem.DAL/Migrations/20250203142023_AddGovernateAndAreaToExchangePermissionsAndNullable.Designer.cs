...
namespace LoyaltyCouponsSystem.DAL.Migrations
{
    ...
    [Migration("20250203142023_AddGovernateAndAreaToExchangePermissionsAndNullable")]
    partial class AddGovernateAndAreaToExchangePermissionsAndNullable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LoyaltyCouponsSystem.DAL.Entity.ApproveRecievedCoupons", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("ApproveRecievedCoupons");
                });
            ...
            modelBuilder.Entity("LoyaltyCouponsSystem.DAL.Entity.ReceiveFromCustomer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<long>("CouponReceiptNumber")
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("ReceiveFromCustomers");
                });
            ...
            modelBuilder.Entity("LoyaltyCouponsSystem.DAL.Entity.Representative", b =>
                {
                    ...
                    b.Property<int?>("TransactionForRecieptFromRepToCustID")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("TransactionForRecieptFromRepToCustID");
            ...
            modelBuilder.Entity("LoyaltyCouponsSystem.DAL.Entity.TechnicianCustomer", b =>
                {
                    b.Property<int>("TechnicianId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("TechnicianId", "CustomerId");
            ...
            modelBuilder.Entity("LoyaltyCouponsSystem.DAL.Entity.TransactionForRecieptFromRepToCust", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("ExchangePermissionNumber")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("ReprsentitiveCode")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.ToTable("TransactionForRecieptFromRepToCusts");
                });
            ...
            modelBuilder.Entity("LoyaltyCouponsSystem.DAL.Entity.ApproveRecievedCoupons", b =>
                {
                    b.HasOne("LoyaltyCouponsSystem.DAL.DB.ApplicationUser", "ApplicationUser")
                        .WithMany("ApproveRecievedCoupons")
            ...
            modelBuilder.Entity("LoyaltyCouponsSystem.DAL.Entity.QRScanLog", b =>
                {
                    b.HasOne("LoyaltyCouponsSystem.DAL.Entity.Coupon", "Coupon")
                        .WithOne("QRScanLog")
                        .HasForeignKey("LoyaltyCouponsSystem.DAL.Entity.QRScanLog", "CouponId")
                        .OnDelete(DeleteBehavior.Cascade);
            ...
            modelBuilder.Entity("LoyaltyCouponsSystem.DAL.Entity.Representative", b =>
                {
                    ...
                    b.HasOne("LoyaltyCouponsSystem.DAL.Entity.TransactionForRecieptFromRepToCust", null)
                        .WithMany("Representatives")
                        .HasForeignKey("TransactionForRecieptFromRepToCustID");
            ...
            modelBuilder.Entity("LoyaltyCouponsSystem.DAL.DB.ApplicationUser", b =>
                {
                    ...
                    b.Navigation("ApproveRecievedCoupons");
            ...
            modelBuilder.Entity("LoyaltyCouponsSystem.DAL.Entity.Customer", b =>
                {
                    ...
                    b.Navigation("TechnicianCustomers");
